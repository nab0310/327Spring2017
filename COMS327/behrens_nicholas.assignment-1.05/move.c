...
;
  ...
  if (pc_is_alive(d) && e->c == &d->pc) {
    ...
    e->c = NULL;
    event_delete(e);
    d->renderStart[dim_x] = d->pc.position[dim_x] - 40;
    d->renderStart[dim_y] = d->pc.position[dim_y] - 10;
    d->renderEnd[dim_x] = d->pc.position[dim_x] + 40;
    d->renderEnd[dim_y] = d->pc.position[dim_y] + 10;
    pc_next_pos(d, next);
    next[dim_x] += c->position[dim_x];
    next[dim_y] += c->position[dim_y];
