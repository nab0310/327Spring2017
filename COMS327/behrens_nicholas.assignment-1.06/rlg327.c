...
int main(int argc, char *argv[])
{
 ...
 if (argc > 1) {
    for (i = 1, long_arg = 0; i < argc; i++, long_arg = 0) {
      if (argv[i][0] == '-') { /* All switches start with a dash */
        ...
        case 'p':
          ...
          // }
          // do_place_pc = 1;
          // if ((d.pc->character_set_y(d.pc, atoi(argv[++i]))) < 1 ||
  ...
  //printf(is_character_alive(d.pc) ? victory : tombstone);
  printf("\nYou defended your life in the face of %u deadly beasts.\n"
         ...
         character_get_kills(d.pc, kill_direct), character_get_kills(d.pc, kill_avenged));
